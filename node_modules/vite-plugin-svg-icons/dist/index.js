...
var require_stringify = __commonJS({
  "node_modules/fast-glob/node_modules/braces/lib/stringify.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
...
var require_is_number = __commonJS({
  "node_modules/fast-glob/node_modules/is-number/index.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
...
var require_to_regex_range = __commonJS({
  "node_modules/fast-glob/node_modules/to-regex-range/index.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
...
var require_fill_range = __commonJS({
  "node_modules/fast-glob/node_modules/fill-range/index.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
...
var require_compile = __commonJS({
  "node_modules/fast-glob/node_modules/braces/lib/compile.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
...
var require_expand = __commonJS({
  "node_modules/fast-glob/node_modules/braces/lib/expand.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
    var fill = require_fill_range();
...
var require_constants = __commonJS({
  "node_modules/fast-glob/node_modules/braces/lib/constants.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
    module2.exports = {
      MAX_LENGTH: 1024 * 64,
...
var require_parse = __commonJS({
  "node_modules/fast-glob/node_modules/braces/lib/parse.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
    var stringify = require_stringify();
    var {
...
var require_braces = __commonJS({
  "node_modules/fast-glob/node_modules/braces/index.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
    var stringify = require_stringify();
...
var require_micromatch = __commonJS({
  "node_modules/fast-glob/node_modules/micromatch/index.js"(exports, module2) {
    init_cjs_shims();
    "use strict";
    var util = require("util");
...
// src/index.ts
__export(exports, {
  compilerIcon: () => compilerIcon,
  compilerIcons: () => compilerIcons,
  createModuleCode: () => createModuleCode,
  createSymbolId: () => createSymbolId,
  default: () => src_default,
  discreteDir: () => discreteDir
});
init_cjs_shims();
...
var import_svg_baker = __toModule(require("svg-baker"));
var debug = (0, import_debug.debug)("vite-plugin-svg-icons");
var src_default = (opt) => {
  const cache = new Map();
  let isBuild = false;
  ...
  return {
    ...
    configureServer: ({ middlewares }) => {
      middlewares.use((0, import_cors.default)({ origin: "*" }));
      middlewares.use(async (req, res, next) => {
        const url = (0, import_vite.normalizePath)(req.url);
        ...
        if ([...clientIds, ...registerIds].some((item) => url.endsWith(item))) {
          ...
          res.setHeader("Etag", (0, import_etag.default)(content, { weak: true }));
          res.statusCode = 200;
          res.end(content);
        } else {
          next();
  ...
  for (const dir of iconDirs) {
    ...
    for (const entry of svgFilsStats) {
      ...
      const getSymbol = async () => {
        relativeName = (0, import_vite.normalizePath)(path2).replace((0, import_vite.normalizePath)(dir + "/"), "");
...
function createSymbolId(name, options) {
  ...
  return id.replace(import_path.default.extname(id), "");
}
function discreteDir(name) {
  if (!(0, import_vite.normalizePath)(name).includes("/")) {
    return {
      fileName: name,
      dirName: ""
    };
