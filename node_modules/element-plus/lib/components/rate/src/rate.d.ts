...
export declare const rateProps: {
    ...
    readonly colors: import("element-plus/es/utils/props").BuildPropReturn<import("element-plus/es/utils/props").PropWrapper<string[] | Record<number, string>>, () => ["var(--el-rate-star-color)", "var(--el-rate-star-color)", "var(--el-rate-star-color)"], unknown, unknown, unknown>;
    readonly voidColor: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, "var(--el-rate-void-color)", unknown, unknown, unknown>;
    readonly disabledVoidColor: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, "var(--el-rate-disable-void-color)", unknown, unknown, unknown>;
    ...
    readonly textColor: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, "var(--el-rate-text-color)", unknown, unknown, unknown>;
