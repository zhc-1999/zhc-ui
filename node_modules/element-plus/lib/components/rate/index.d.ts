export declare const ElRate: import("../../utils/types").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly colors: import("../../utils/props").BuildPropReturn<import("../../utils/props").PropWrapper<string[] | Record<number, string>>, () => ["var(--el-rate-star-color)", "var(--el-rate-star-color)", "var(--el-rate-star-color)"], unknown, unknown, unknown>;
    readonly voidColor: import("../../utils/props").BuildPropReturn<StringConstructor, "var(--el-rate-void-color)", unknown, unknown, unknown>;
    readonly disabledVoidColor: import("../../utils/props").BuildPropReturn<StringConstructor, "var(--el-rate-disable-void-color)", unknown, unknown, unknown>;
    ...
    readonly textColor: import("../../utils/props").BuildPropReturn<StringConstructor, "var(--el-rate-text-color)", unknown, unknown, unknown>;
