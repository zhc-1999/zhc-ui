...
export declare const avatarProps: {
    readonly size: import("element-plus/es/utils/props").BuildPropReturn<readonly [NumberConstructor, StringConstructor], "default", unknown, "small" | "default" | "large", number>;
