...
var index$7 = require('../../../hooks/use-draggable/index.js');
var index$8 = require('../../../hooks/use-same-target/index.js');
var index$9 = require('../../../hooks/use-modal/index.js');
var index$a = require('../../../hooks/use-prevent-global/index.js');
var index$b = require('../../../hooks/use-lockscreen/index.js');
var index$c = require('../../../hooks/use-restore-active/index.js');
...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    index$7.useDraggable(rootRef, headerRef, draggable);
    vue.onMounted(async () => {
      await vue.nextTick();
    ...
    if (props.closeOnPressEscape) {
      ...
      index$a.usePreventGlobal(visible, "keydown", (e) => e.code === aria.EVENT_CODE.esc);
    }
    if (props.lockScroll) {
      index$b.useLockscreen(visible);
    }
    index$c.useRestoreActive(visible);
    return {
      ...vue.toRefs(state),
      overlayEvent,
      visible,
