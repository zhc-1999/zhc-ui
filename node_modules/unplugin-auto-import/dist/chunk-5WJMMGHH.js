...
var _chunkT37YOLOKjs = require('./chunk-T37YOLOK.js');
...
function resolveOptions(options = {}) {
  ...
  const resolved = _chunkT37YOLOKjs.__spreadProps.call(void 0, _chunkT37YOLOKjs.__spreadValues.call(void 0, {
    sourceMap: false,
    resolvedImports: {},
...
function flattenImportsMap(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkT37YOLOKjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkT37YOLOKjs.presets[definition];
